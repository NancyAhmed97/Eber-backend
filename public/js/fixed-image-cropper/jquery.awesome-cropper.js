...
(function() {
  ...
  $.awesomeCropper = function(inputAttachTo, options) {
    ...
    input = function(type) {
      return $(`<div class='form-group'> <div class='col-md-12 col-xs-12'><input type="${type}" class='btn btn-success btn-block btn-rounded fileinput' data-filename-placement='inside' name='file' accept="image/*" title='Change Photo' id='profile_image'/></div></div>`);
    };
    div = function() {
      return $("<div/>");
    };
    ...
    image = function() {
      return $('<img  class="img-thumbnail" id="profile_sel_img" style="margin-top: 15px;margin-bottom: 15px;margin-left: 15px"/>');
    };
    // Main box
