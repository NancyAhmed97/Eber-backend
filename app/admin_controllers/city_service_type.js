...
exports.city_type = function (req, res, next) {
    if (typeof req.session.userid != 'undefined') {
        ...
        City_type.aggregate([lookup, unwind, lookup1, unwind1, lookup2, unwind2, search, filter, count]).then((array) => {
            ...
            {
                array = [];
                res.render('city_type', { detail: array, 'current_page': 1, 'pages': 0, 'next': 1, 'pre': 0, moment: moment, sort_field, sort_order, search_item, search_value, filter_start_date, filter_end_date });
                delete message;
            } else
            {
                ...
                City_type.aggregate([lookup, unwind, lookup1, unwind1, lookup2, unwind2, search, filter, sort, skip, limit]).then((array) => {
                    ...
                    res.render('city_type', { detail: array, 'current_page': page, 'pages': pages, 'next': next, 'pre': pre, moment: moment, sort_field, sort_order, search_item, search_value, filter_start_date, filter_end_date });
                    delete message;
                });
            }
        });
...
exports.add_city_type_form = function (req, res) {
    if (typeof req.session.userid != "undefined") {
...
exports.getcitytype = function (req, res) {
    ...
    var cityid_condition = {$match: {'cityname': {$eq: req.body.city},'is_business' : 1}};
