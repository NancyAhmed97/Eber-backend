...
exports.provider_request = function (req, res, next) {
    if (typeof req.session.provider == 'undefined') {
        ...
        Trip_history.aggregate([ condition, lookup, unwind, lookup1,search, filter]).then((array) => { 
         ...
         if (array.length == 0) {
             res.render('provider_request_list', { detail: array, moment: moment, sort_field, sort_order, search_item, search_value, filter_start_date, filter_end_date });
        } else {
...
exports.provider_wallet_history = function (req, res) {
    if (typeof req.session.provider != 'undefined') {
...
exports.provider_history_export_excel = function (req, res) {
