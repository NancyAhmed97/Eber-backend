...
module.exports = function (app) {
    ...
    app.route('/corporate_genetare_request_excel').post(corporate.genetare_request_excel);
    
    app.route('/corporate_history').get(corporate.corporate_request);
    app.route('/corporate_history').post(corporate.corporate_request);
    ...
    app.route('/corporate_genetare_future_request_excel').post(corporate.genetare_future_request_excel);
